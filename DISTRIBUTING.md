For distributing a new PaperCSS2 version to GitHub, NPM, and the CDN
...
4. Push to `main`
5. Create a new release in the GitHub UI for `digix-kr/papercss2`
...
6. Publish the `papercss2` package to NPM with `npm publish`. The CDN will automatically pick up the new files after the package is available.
